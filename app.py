...
print("\033[1ma) Neolítico, b) Paleolítico, c) Idade dos Metais, d) Período da Pedra Polida, e) Idade Média\033[m")
fourth_question = str(input("Resposta: "))
if fourth_question[0].upper() != "B":
    print("\033[1;31mAlternativa errada! Tente acertar a última.\033[m")
else:
    score += 1
    print("\033[1;32mAlternativa correta, parabéns!\033[m")
